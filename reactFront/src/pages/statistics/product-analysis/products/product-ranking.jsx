...
const ProductRanking = ({ setData, setTotalSalesData, setSalesQuantityData, data }) => {
  const [picker, setPicker] = useState();
  const [picker2, setPicker2] = useState();

  useEffect(() => {
    fetch('http://localhost:8081/admin/statistics/products?dateStart&dateEnd', { method: 'GET' })
      .then((res) => res.json())
      .then((res) => {
        console.log('res:', res);
  ...
  return (
    <div>
      <Card title='판매상품 순위' noborder className='font-bold'>
