...
const ReturnChart = ({ refundQuantityData, returnRateData, label }) => {
  ...
  const options = {
    labels: refundQuantityData
      ...
      : returnRateData
      ? returnRateData.map((data) => data.productName)
      : null,
  ...
  return (
    <div>
      <Chart options={options} series={series || returnSeries} type='donut' height='450' width='600' />
    </div>
  );
};
