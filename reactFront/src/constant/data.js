export const menuItems = [
  ...
  },
  {
    ...
    child: [
      {
        childtitle: '상품 대시보드',
        childlink: 'admin/products/dashboard',
      },
      {
        childtitle: '상품 목록',
        childlink: 'admin/products/search',
      },
      {
        childtitle: '상품 등록',
  ...
  },
  {
    ...
    link: '/admin/statistics/dashboard',
    child: [
      {
        childtitle: '통계 대시보드',
        childlink: 'admin/statistics/dashboard',
      },
      {
        childtitle: '매출 분석',
        childlink: 'chart2',
        multi_menu: [
          {
            multiTitle: '일별 매출',
            multiLink: 'admin/statistics/daily',
          },
          {
            multiTitle: '주별 매출',
            multiLink: 'admin/statistics/weekly',
          },
          {
            multiTitle: '월별 매출',
            multiLink: 'admin/statistics/monthly',
          },
          {
            multiTitle: '매출 집계(판매 이익)',
            multiLink: 'admin/statistics/revenue',
          },
        ],
      },
      {
        ...
        multi_menu: [
          {
            multiTitle: '판매 상품 순위',
            multiLink: 'admin/statistics/products',
          },
          {
            multiTitle: '판매 분류 순위',
            multiLink: 'admin/statistics/categories',
          },
          {
            multiTitle: '취소/반품 순위',
            multiLink: 'admin/statistics/returns',
          },
          {
            multiTitle: '장바구니 상품 분석',
            multiLink: 'admin/statistics/cart',
          },
          {
            multiTitle: '관심 상품 분석',
            multiLink: 'admin/statistics/wishlist',
          },
        ],
      },
    ],
