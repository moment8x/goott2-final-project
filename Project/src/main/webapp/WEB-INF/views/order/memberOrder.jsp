...
$(function() {
	...
	function checkPayMethod() {
		...
		if ($("input[name='payMethod']").is(':checked')) {
			...
			if (payMethod == "bkt") {
				let bktPayNo = "bkt" + ((String(new Date().getTime())).substring(1));
				obj = {
													...
													<div class="delivery-address-box">
														<div>
															...
															<ul class="delivery-address-detail">
																<li>
																	<h4 class="fw-500"><input readonly="readonly" style="border:none" value="집"></h4>
																</li>

																<li>
																	<p class="text-content">
																		<span class="text-title">주소 : </span><input name="shipping_address" readonly="readonly" style="border:none" value="깐따삐야별"><input name="detailed_shipping_address" readonly="readonly" style="border:none" value="302호">
																	</p>
																</li>

																<li>
																	<h6 class="text-content">
																		<span class="text-title">수령인: </span> <input name="recipient_name" readonly="readonly" style="border:none" value="둘리">
																	</h6>
																</li>

																<li>
																	<h6 class="text-content mb-0">
																		<span class="text-title">휴대폰번호: </span> <input name="recipient_phone_number" readonly="readonly" style="border:none" value="010-1111-1111">
																		...
																		<div class="select-option">
																			<div class="form-floating theme-form-floating">
																				<select class="form-select theme-form-select"
																					aria-label="Default select example" name="delivery_message">
					...
					<div class="right-side-summery-box">
						...
						<div class="checkout-offer">
							...
							<ul class="offer-detail">
								<li>
									<p>Combo: BB Royal Almond/Badam Californian, Extra Bold 100
										gm...</p>
								</li>
								<li>
