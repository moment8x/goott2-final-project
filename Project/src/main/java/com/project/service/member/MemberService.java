...
public interface MemberService {
	...
	// 특정 회원 탈퇴
	Boolean withdraw(String memberId) throws SQLException, NamginException;
	// 배송지 목록 조회
	List<ShippingAddress> getShippingAddress(String memberId) throws SQLException, NamginException;
	// 리뷰 조회
