	...
	public boolean insertMember(SignUpDTO member) throws SQLException, NamingException {
		...
		if (member.getCellPhoneNumber() == null || member.getCellPhoneNumber().length() < 1) {
			member.setPhoneNumber(
					member.getPhoneNumber1() + "-" + member.getPhoneNumber2() + "-" + member.getPhoneNumber1());
			member.setCellPhoneNumber(member.getCellPhoneNumber1() + "-" + member.getCellPhoneNumber2() + "-"
					+ member.getCellPhoneNumber3());
		}
		// 회원 가입 - 프로필 사진 저장
